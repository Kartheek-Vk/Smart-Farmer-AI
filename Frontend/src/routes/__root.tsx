...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Smart Farmer AI" },
      { title: "Smart Farmer AI — AI advice for Indian farms" },
      {
        name: "description",
        content:
          "Smart Farmer AI gives farmers disease detection, crop and fertilizer advice, irrigation planning, weather and mandi prices in one simple app.",
      },
